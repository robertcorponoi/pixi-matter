...
import { PhysicsSprite } from "./physics_objects/physics_sprite.js";
import { PhysicsGraphics } from "./physics_objects/physics_graphics.js";
...
export class PixiMatter {
    ...
    removeFromWorld(...pixiObjects: Array<PhysicsSprite | PhysicsGraphics>) {
        ...
        this._pixiObjects = this._pixiObjects.filter(
            (po) => !pixiObjects.includes(po),
        );
    }
}
